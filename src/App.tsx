          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-purple-900/50 p-6 sm:p-8 rounded-xl border border-purple-800 mb-10">
                ...
                <p className="text-lg text-center mb-8">But here's the good news...</p>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="flex flex-col items-center p-6 bg-purple-900/50 rounded-xl border border-yellow-500">
                    ...
                    <a 
                      href="https://app.mailingboss.com/lists/682c923dc26af/subscribe" 
                      target="_blank" 
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-purple-900/50 p-8 rounded-xl border border-purple-800">
                  ...
                  <p className="text-lg">Decide to register later only to see that the special offer has ended and you'd have to pay ₦4.5M instead of the early bird rate</p>
                </div>
                <div className="bg-purple-900/50 p-8 rounded-xl border border-purple-800">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid sm:grid-cols-2 md:grid-cols-2 gap-12 mb-12">
                <div className="text-center">
                  <h3 className="text-lg sm:text-xl font-bold mb-4 text-yellow-500">CEO Leadership Retreat</h3>
                  <p className="text-purple-300 mb-6 text-sm sm:text-base">Where visionary leaders unite, refresh, and strategize for greater impact.</p>
                  <div className="flex justify-center space-x-6">
                    <a href="https://www.facebook.com/drsakintayo" className="text-purple-300 hover:text-yellow-500 transition-colors" target="_blank">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                      </svg>
                    </a>
                    <a href="https://x.com/drsakintayo" className="text-purple-300 hover:text-yellow-500 transition-colors" target='_blank'>
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                      </svg>
                    </a>
                    <a href="https://www.instagram.com/stephenakintayo/" className="text-purple-300 hover:text-yellow-500 transition-colors" target='_blank'>
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="text-center">
                  ...
                  <p className="text-purple-300 mb-3">Email: products@stephenakintayo.com</p>
                  <p className="text-purple-300 mb-3">Phone: (+234) 815 5555 616</p>
                  <p className="text-purple-300">Phone: (+234) 816 7901 719</p>
                </div>
              </div>
              <div className="border-t border-purple-800 pt-6 text-center">
                <p className="text-purple-300">© 2025 CEO Leadership Retreat Doha. All rights reserved.</p>
              </div>
            </div>
          </div>
        </footer>
